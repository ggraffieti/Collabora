...
object Test extends App {
  ...
  //val note: SimpleNote = new SimpleNote(content = "Insertion test", state = NoteState("todo", None), location = Some(Location(2541, 45.2541)), previousNotes = Some(List("5980710df27da3fcfe0ac88d", "59806ff7f27da3fcfe0ac7d2")), expiration = Some(DateTime.now()))
