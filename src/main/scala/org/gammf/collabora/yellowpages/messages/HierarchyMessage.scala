...
/**
  * Represents a request sent to an [[org.gammf.collabora.yellowpages.actors.YellowPagesActor]] in order to build a hierarchical structure of the actor system.
